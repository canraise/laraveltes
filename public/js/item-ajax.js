...
$(".crud-submit").click(function (e) {
    ...
    var konten = $("#create-item").find("textarea[name='konten']").val();
...
$("body").on("click", ".edit-item", function () {
    ...
    var konten = $(this).parent("td").prev("td").text();

    $("#edit-item").find("input[name='judul']").val(judul);

    $("#edit-item").find("textarea[name='konten']").val(konten);
...
$(".crud-submit-edit").click(function (e) {
    ...
    var konten = $("#edit-item").find("textarea[name='konten']").val();
